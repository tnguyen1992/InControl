...
%
%
% Version 1.63, copyright (c) by Artinis Medical Systems http://www.artinis.com
...
if nargin < 5
  metaProj = [];
  fprintf('[Artinis] Thank you for using oxysoft2matlab v1.63 (c) Artinis Medical Systems.\n');
  if nargin < 4
    verbose = true;
    if nargin < 3
      savename = '';
