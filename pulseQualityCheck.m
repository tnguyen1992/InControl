function badChannels = pulseQualityCheck( data, SD, t )
% PULSEQUALTITYCHECK is a function for a visual data quality check. It
...
%
% Use as
%   badChannel = pulseQualityCheck( data, SD )
%
