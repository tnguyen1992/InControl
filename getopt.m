function value = getopt(structure, option, defaultVal)
% GETOPT gets the value of a specified option from a cfg structure.
%
% Use as
%   value = getopt(structure, option, defaultVal)
