function saveData( cfg, varargin )
...
% Get config options
% -------------------------------------------------------------------------
desFolder   = getopt(cfg, 'desFolder', '\\fs.univie.ac.at\homedirs\nguyenq22\Documents\Projekte\InControl\procData\');
filename    = getopt(cfg, 'filename', '29_preproc');
% sessionStr  = CARE_getopt(cfg, 'sessionStr', '001');

% -------------------------------------------------------------------------
% Save data
% -------------------------------------------------------------------------
file_path = strcat(desFolder, filename, '.mat');
