function [ badChannels ] = channelCheckbox()
% RNB_CHANNELCHECKBOX is a function, which displays a small GUI for the 
% selection of bad channels. It returns a vector including the numbers
% of the bad channels
%
% Use as
%   [ badChannel ] = RNB_channelCheckbox()
%
% SEE also UIFIGURE, UICHECKBOX, UIBUTTON, UIRESUME, UIWAIT

% Copyright (C) 2018, Daniel Matthes, MPI CBS, 2019, Trinh Nguyen
...
Elec.Ch01.Text = 'Ch01';
Elec.Ch01.Position = [45 175 80 15];
% Create Ch02CheckBox
Elec.Ch02 = uicheckbox(SelectBadChannels);
Elec.Ch02.Text = 'Ch02';
Elec.Ch02.Position = [125 175 80 15];
% Create Ch03CheckBox
Elec.Ch03 = uicheckbox(SelectBadChannels);
Elec.Ch03.Text = 'Ch03';
Elec.Ch03.Position = [205 175 80 15];
% Create Ch04CheckBox
Elec.Ch04 = uicheckbox(SelectBadChannels);
Elec.Ch04.Text = 'Ch04';
Elec.Ch04.Position = [285 175 80 15];

% Create Ch05CheckBox
Elec.Ch05 = uicheckbox(SelectBadChannels);
Elec.Ch05.Text = 'Ch05';
Elec.Ch05.Position = [45 150 80 15];
% Create Ch06CheckBox
Elec.Ch06 = uicheckbox(SelectBadChannels);
Elec.Ch06.Text = 'Ch06';
Elec.Ch06.Position = [125 150 80 15];
% Create Ch07CheckBox
Elec.Ch07 = uicheckbox(SelectBadChannels);
Elec.Ch07.Text = 'Ch07';
Elec.Ch07.Position = [205 150 80 15];
% Create Ch08CheckBox
Elec.Ch08 = uicheckbox(SelectBadChannels);
Elec.Ch08.Text = 'Ch08';
Elec.Ch08.Position = [285 150 80 15];

% Create Ch09CheckBox
Elec.Ch09 = uicheckbox(SelectBadChannels);
Elec.Ch09.Text = 'Ch09';
Elec.Ch09.Position = [45 125 80 15];
% Create Ch10CheckBox
Elec.Ch10 = uicheckbox(SelectBadChannels);
Elec.Ch10.Text = 'Ch10';
Elec.Ch10.Position = [125 125 80 15];
% Create Ch11CheckBox
Elec.Ch11 = uicheckbox(SelectBadChannels);
Elec.Ch11.Text = 'Ch11';
Elec.Ch11.Position = [205 125 80 15];
% Create Ch12CheckBox
Elec.Ch12 = uicheckbox(SelectBadChannels);
Elec.Ch12.Text = 'Ch12';
Elec.Ch12.Position = [285 125 80 15];

% Create Ch13CheckBox
Elec.Ch13 = uicheckbox(SelectBadChannels);
Elec.Ch13.Text = 'Ch13';
Elec.Ch13.Position = [45 100 80 15];
% Create Ch14CheckBox
Elec.Ch14 = uicheckbox(SelectBadChannels);
Elec.Ch14.Text = 'Ch14';
Elec.Ch14.Position = [125 100 80 15];
% Create Ch15CheckBox
Elec.Ch15 = uicheckbox(SelectBadChannels);
Elec.Ch15.Text = 'Ch15';
Elec.Ch15.Position = [205 100 80 15];
% Create Ch16CheckBox
Elec.Ch16 = uicheckbox(SelectBadChannels);
Elec.Ch16.Text = 'Ch16';
Elec.Ch16.Position = [285 100 80 15];

% Create Ch17CheckBox
Elec.Ch17 = uicheckbox(SelectBadChannels);
Elec.Ch17.Text = 'Ch17';
Elec.Ch17.Position = [45 75 80 15];
% Create Ch18CheckBox
Elec.Ch18 = uicheckbox(SelectBadChannels);
Elec.Ch18.Text = 'Ch18';
Elec.Ch18.Position = [125 75 80 15];
% Create Ch19CheckBox
Elec.Ch19 = uicheckbox(SelectBadChannels);
Elec.Ch19.Text = 'Ch19';
Elec.Ch19.Position = [205 75 80 15];
% Create Ch20CheckBox
Elec.Ch20 = uicheckbox(SelectBadChannels);
Elec.Ch20.Text = 'Ch20';
Elec.Ch20.Position = [285 75 80 15];

% Create Ch21CheckBox
Elec.Ch21 = uicheckbox(SelectBadChannels);
Elec.Ch21.Text = 'Ch21';
Elec.Ch21.Position = [45 50 80 15];
% Create Ch22CheckBox
Elec.Ch22 = uicheckbox(SelectBadChannels);
Elec.Ch22.Text = 'Ch22';
Elec.Ch22.Position = [125 50 80 15];
% Create Ch23CheckBox
Elec.Ch23 = uicheckbox(SelectBadChannels);
Elec.Ch23.Text = 'Ch23';
Elec.Ch23.Position = [205 50 80 15];

% Create SaveButton
btn = uibutton(SelectBadChannels, 'push');
btn.ButtonPushedFcn = @(btn, evt)SaveButtonPushed(SelectBadChannels);
btn.Position = [137 25 101 21];
btn.Text = 'Save';
...
if ishandle(SelectBadChannels)                                              % if gui still exists
  badChannels  = [ Elec.Ch01.Value; Elec.Ch02.Value; Elec.Ch03.Value; ...    % return existing selection
                  ...
                  Elec.Ch16.Value; Elec.Ch17.Value; Elec.Ch18.Value; ...
                  Elec.Ch19.Value; Elec.Ch20.Value; Elec.Ch21.Value; ...
                  Elec.Ch22.Value; Elec.Ch23.Value];
  number      = 1:23;
